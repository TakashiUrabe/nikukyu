module CreateProfileCard
  ...
  def create_profile_card(type)
    ...
    hash_i = {'base_img_url': './app/assets/images/base_img_i.png', 'color': 'white', 'personality_position': [0,-850], 'birthday_position': [0,-800], 'breed_position': [0,-750], 'treat_position': [0,-700], 'toy_position': [0,-650], 'name_color': 'white', 'name_position': [0,100], 'face_position': [0,350], 'write_url': './app/assets/images/profile_card_data_i.jpg'}
